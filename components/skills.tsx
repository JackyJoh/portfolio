    ...
    <section className="py-20 px-4 md:px-8">
      <div className="max-w-4xl mx-auto">
        ...
        <div className="mt-12 pt-12 border-t border-border">
          ...
          <div className="flex flex-wrap gap-2">
            {['Data Structures & Algorithms', 'Advanced Programming Fundamentals', 'Introduction to Statistics', 'Discrete Structures', 'Computational Linear Algebra', 'Computer Organization'].map((course, i) => (
              <span key={i} className="px-3 py-1 border border-border text-sm text-muted-foreground rounded">
                {course}
              </span>
            ))}
          </div>
